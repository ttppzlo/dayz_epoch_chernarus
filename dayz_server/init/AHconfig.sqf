...
/*  АДМИНИСТРАЦИЯ UID      		 */ 			_SAdmins = ["76561197988068204"]; 	 			/* 76561197988068204 */
...
/* ***************************** ESC МЕНЮ **************************************** */
/*  ESC меню Верхний текст       */ 			_TopOfESC = "12345"; 				/* Сообщение которое будет показываться наверху меню ESC. */
/*  ESC меню Нижний текст #1   	 */ 			_LowerTop = "123456"; 				/* Сообщение которое будет показываться внизу меню ESC. */
/*  ESC меню Нижний текст #2  	 */ 			_LowerBottom = "1234567"; 					/* Сообщение которое будет показываться внизу меню ESC. */
...
/*  Ломать игровые функции читаку?     */ 			_BHF =  false;		/* Рекомендуется:  true 	  */				/* Ломает некоторые функции читаку при использовании читов, тем самым ограничит использование читов. */
...
/*  Голосование за День/Ночь?  		   */			_UDN =  false;		/* Рекомендуется:  false 	  */				/* Игроки могут использовать голосование, чтобы включить день или ночь на сервере. */
...
/*  Блокировать Диалоги ?       */ _CUD =  false;		/* Рекомендуется:  true */
...
/*  РАЗРЕШЕННЫЕ ДИАЛОГ СЦЕНАЦИИ       */ _ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,12000,12001,12002,12003,12004,12005,12006,711194,711197,88890,55510];
...
[
	...
	"BTC_Hud","PlotManagement","AdvancedTrading"
];
