...
/*  АДМИНИСТРАЦИЯ UID      		 */ 			_SAdmins = ["76561197988068204","76561198019307713"]; 								/* Пишем UID игрока для выдачи прав Администрации. */
...
/*  РАЗРЕШЕННЫЕ ДИАЛОГ СЦЕНАЦИИ       */ _ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,711194];
