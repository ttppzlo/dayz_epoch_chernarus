...
/* ***************************** ESC МЕНЮ **************************************** */
/*  ESC меню Верхний текст       */ 			_TopOfESC = "FAQGAME.RU"; 				/* Сообщение которое будет показываться наверху меню ESC. */
/*  ESC меню Нижний текст #1   	 */ 			_LowerTop = "vk.com/faqgame"; 				/* Сообщение которое будет показываться внизу меню ESC. */
/*  ESC меню Нижний текст #2  	 */ 			_LowerBottom = "DAYZ.FAQGAME.RU"; 					/* Сообщение которое будет показываться внизу меню ESC. */
...
/*  РАЗРЕШЕННЫЕ ДИАЛОГ СЦЕНАЦИИ       */ _ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,711194,129,666,667,4444,65431,65432,65433,65434,65440,65441,65442,571113,12000,12001,12002,12003,12004,12005,12006,55510,2800,3800,118339,118338,8407,8406];
